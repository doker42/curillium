                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('create_about') }}" class="btn btn-primary">Add aboutme</a>
                        </div>
                    </div>
...
{{--                                        <td>{{ $item->status }}</td>--}}
                                        ...
                                        @if($item->status)
                                            <td><a href="" class="btn btn-success disabled">Active about</a></td>
                                        @else
                                            <form role="form" action="">
                                                <td>
                                                    <a href="{{ route('update_status_about', $item ) }}" onclick="return confirm('Are you sure?')" class="btn btn-success">On</a>
                                                </td>
                                            </form>
                                        @endif
